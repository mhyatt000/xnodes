...
class IccCalibrator(object):
    ...
    def initDesignVariables(
        ...
        self.CameraChain.addDesignVariables(
            problem, noTimeCalibration, noChainExtrinsics
        )
    ...
    def buildProblem(
        ...
        for imu in self.ImuList:
            imu.addAccelerometerErrorTerms(
                problem,
                self.poseDv,
    ...
    def recoverCovariance(self):
        ...
        estimator.addBatch(self.problem, True)
